...
module.exports = function(app) {
  ...
  app.get('/fhir/dre/user', auth.ensureAuthenticated, fhir.dreuser);
  app.get('/fhir/smart/user', auth.ensureAuthenticated, fhir.smartuser);
  app.get('/fhir/dre/meds', auth.ensureAuthenticated, fhir.dremeds);
  app.get('/fhir/smart/meds', auth.ensureAuthenticated, fhir.smartmeds);
